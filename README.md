...
- **Power-ups and bombs** introduce screen-clearing ordnance, hull repairs, shield boosts, speed bursts, a three-tier Canon blaster that grows into multi-shot volleys with homing missiles at higher tiers, a three-tier spread cannon, and a piercing laser cannon to help players survive three hits per life across three lives.
